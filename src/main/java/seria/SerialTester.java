...
public class SerialTester {
    public static void main(String[] args) throws IOException {
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("/Users/tatyanakupreeva/Documents/io_tests/seria_user.txt"));
...
//   //     deserialization (converting from bytes into Java Object)
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("/Users/tatyanakupreeva/Documents/io_tests/seria_user.txt"));
        try {
