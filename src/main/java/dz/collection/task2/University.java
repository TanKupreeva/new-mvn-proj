...
//    public static List<Student> getStudents(List<Student> students, Lecturer lecturer) {
//        List<Student> studentOfLecturer = new ArrayList<>();
//        List<String> listsubjects = new ArrayList<>();
//        for (Student anystudent : students) {
//            listsubjects = anystudent.getCourses();
//            for (String anylistsubjects : listsubjects) {
//                for (String anyTaughtCourses: t)
//                if (anylistsubjects == lecturer.getTaughtCourses(1)||) {
//
//            ==lecturer.getTaughtCourses()){
//                    }
//                    studentOfLecturer.add(anystudent);
//                }
//            }
...
//            System.out.println("Student of teacher :" + getStudents(students, lecturer6));
            System.out.println("Student of subject :" + getStudents(students, subject9));
